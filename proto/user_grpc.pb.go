...
const (
	...
	UserService_GetAllUser_FullMethodName = "/proto.UserService/GetAllUser"
)
...
type UserServiceClient interface {
	...
	GetAllUser(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*UserListResponse, error)
}
...
func (c *userServiceClient) GetAllUser(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*UserListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	GetAllUser(context.Context, *Empty) (*UserListResponse, error)
...
func (UnimplementedUserServiceServer) GetAllUser(context.Context, *Empty) (*UserListResponse, error) {
